...
public abstract partial class HTMLBodyElement : HTMLElement
{
    ...
    /// </returns>
    public HTMLBodyElement Header(HeaderLevel level, string content)
    {
        var h = new Header(level, content, this);
        AddElement(h);
        return this;
    }
    public HTMLBodyElement Header(out HTMLBodyElement saveIn, HeaderLevel level, string content)
    {
        var h = new Header(level, content, this);
        saveIn = h;
        AddElement(h);
