...
public abstract partial class HTMLBodyElement : HTMLElement
{
    ...
    /// </returns>
    public HTMLBodyElement Strong()
    {
        var strong = new Strong(this);
        AddElement(strong);
        return this;
    }
    public HTMLBodyElement Strong(out HTMLBodyElement saveIn)
    {
        var strong = new Strong(this);
        saveIn = strong;
        AddElement(strong);
    ...
    public HTMLBodyElement Strong(string text)
    {
        var strong = new Strong(text, this);
        AddElement(strong);
        return this;
    }
    public HTMLBodyElement Strong(out HTMLBodyElement saveIn, string text)
    {
        var strong = new Strong(text, this);
        saveIn = strong;
        AddElement(strong);
